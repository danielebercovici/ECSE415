...
#############
        ...
        if(surf_desc== None):
            print('NONEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEDDDDDDD surf')
            continue
        if(len(surf_desc)<30):
            print('NONEEEEEEEEEEEEEEEEEEEEEEEEEEE surf')
            continue
        ...
        if(hog_desc== None):
            print('NONEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEDDDDDDD hog')
            continue
        if(len(hog_desc)<100):
            print('NONEEEEEEEEEEEEEEEEEEEEEEEEEEE hog')
            continue
        labels.append(row['Label'])
        hog_desc =np.squeeze(np.reshape(hog_desc[:100], (1, -1)))
